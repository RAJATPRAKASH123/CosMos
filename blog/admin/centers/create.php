...
<head>
    ...
    <title>Admin Section - Add Organisation Center</title>
</head>
<body>
    <!-- Admin header here -->
    ...
    <div class="admin-wrapper">
        ...
        <div class="admin-content">
            ...
            <div class="content">
                ...
                <h2 class="page-title">Add Center</h2>
                ...
                <form action="create.php" method="post">
                    ...
                    <div>
                        <button type="submit" name = "add-center" class="btn btn-big">Add Center</button>
                    </div>
