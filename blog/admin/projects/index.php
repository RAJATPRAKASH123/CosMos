        ...
        <div class="admin-content">
            ...
            <div class="content">
                ...
                <table>
                    ...
                    <tbody>
                        <?php foreach($projects_info as $key => $project): ?>
                            <tr>
                                ...
                                <td><a href="edit.php?id=<?php echo $project['Project_id'] ?>" class="edit">edit</a></td>
                                <td><a href="index.php?del_id=<?php echo $project['Project_id'] ?>" class="delete">delete</a></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
