...
<head>
    ...
    <title>Admin Section - Edit Satellite</title>
</head>
<body>
    <!-- Admin header here -->
    ...
    <div class="admin-wrapper">
        ...
        <div class="admin-content">
            ...
            <div class="content">
                ...
                <h2 class="page-title">Edit Satellite</h2>

                <form action="edit.php" method="post">
                    <?php include(ROOT_PATH . "/app/helpers/formErrors.php"); ?>
                    <input type="hidden" name="Satellite_ID" value = "<?php echo $satellite_ID ?>">
                    <div>
                    ...
                    <div>
                        <button type="submit" name = "update-satellite" class="btn btn-big">Update Satellite</button>
                    </div>
