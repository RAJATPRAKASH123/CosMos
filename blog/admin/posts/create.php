...
<head>
    ...
    <title>Admin Section - Add Organisation</title>
</head>
<body>
    <!-- Admin header here -->
    ...
    <div class="admin-wrapper">
        ...
        <div class="admin-content">
            <div class="button-group">
                ...
                <a href="index.php" class="btn btn-big">Manage Organisation</a>
            </div>
            <div class="content">

                <h2 class="page-title">Add Organisation</h2>
                ...
                <form action="create.php" method="post">
                    ...
                    <div>
                        <button type="submit" name = "add-org" class="btn btn-big">Add Organisation</button>
                    </div>
